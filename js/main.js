...
(function () {
  ...
  var searchIndex = [
    ...
    { page: "Services", url: "services.html#amorphous-to-crystalline", title: "Amorphous to Crystalline", snippet: "Converting amorphous material into crystalline forms.", keywords: "amorphous crystalline conversion" },
    { page: "Services", url: "services.html#crystallization-development", title: "Crystallization Development", snippet: "Crystallization process development and optimization.", keywords: "crystallization development process optimization" },
    { page: "Services", url: "services.html#solid-state-characterization", title: "Solid State Characterization", snippet: "Comprehensive characterization of solid forms.", keywords: "solid state characterization analysis" },
    { page: "Services", url: "services.html#pka-logp-determination", title: "pKa, Log P/D Determination", snippet: "Physicochemical property determination.", keywords: "pka log p log d determination physicochemical" },
    { page: "Services", url: "services.html#chiral-resolution", title: "Chiral Resolution", snippet: "Resolution of chiral compounds.", keywords: "chiral resolution enantiomer" },
    { page: "Services", url: "services.html#particle-engineering", title: "Particle Engineering", snippet: "Optimizing morphology and particle size distribution.", keywords: "particle engineering size distribution morphology" },
    { page: "Services", url: "services.html#ternary-phase-diagram", title: "Ternary Phase Diagram Development", snippet: "Phase diagram construction for co-crystal systems.", keywords: "ternary phase diagram development" },
    { page: "Services", url: "services.html#preformulation-services", title: "Additional Preformulation Services", snippet: "Additional preformulation support services.", keywords: "preformulation services additional" },
    { page: "Services", url: "services.html#gmp-analysis", title: "GMP Analysis", snippet: "GMP analytical services.", keywords: "gmp analysis analytical" },
